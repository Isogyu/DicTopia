...
## 現在のIssue
Issue 4-1: 共通レイアウト・Navbar・ダークテーマ
...
## 進行中Issueの状況
- `app/layout.tsx` に `Navbar` / `Footer` / ダークモードを適用
- `components/layout/navbar.tsx` を作成
- `components/layout/footer.tsx` を作成
- `npx tsc --noEmit` 成功
- `npm run build` 成功
